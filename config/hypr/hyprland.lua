...
hl.window_rule({ match = { title = "(?i).*(open|save|select|choose|upload|wants to save|wants to open|dialog|confirm|download|file|error|notification|Steam).*" }, float = true, center = true })

hl.window_rule({
    match = { class = "^(pavucontrol|org\\.pulseaudio\\.pavucontrol|nm%-connection%-editor|blue.*|kcm_.*)$" },
    float = true,
    center = true,
    size =
...
-- Open media/docs on empty workspace
